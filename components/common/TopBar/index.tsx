        ...
        <AppBar position="fixed" className=".appbar-shadow" sx={{ backgroundColor: 'background.default' }}>
            <Container maxWidth={false}>
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        <Box component="span" sx={{ mr: { xs: '2em'} }}>
                            {/* NOTIFICATIONS */}
                            <IconButton sx={{ mr: { xs: '0.5em' },width: { xs: 32, sm: 48 }, height: { xs: 32, sm: 48 } }}>
                                <IoNotificationsOutline />
                            </IconButton>
                            {/* INBOX/MESSAGES */}
                            <IconButton sx={{ width: { xs: 32, sm: 48 }, height: { xs: 32, sm: 48 } }}>
                                <IoMailOutline />
                            </IconButton>
                        </Box>
                        ...
                        <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                            ...
                            <Avatar alt="Remy Sharp" src="" sx={{ backgroundColor: "primary.main", width: { xs: 32, sm: 48 }, height: { xs: 32, sm: 48 }}} />
                        </IconButton>
                        <Menu
                            sx={{ mt: '0.5em' }}
